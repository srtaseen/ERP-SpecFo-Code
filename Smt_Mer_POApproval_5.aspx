<%@ Page Title="Revised" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Smt_Mer_POApproval_5.aspx.cs" Inherits="Smt_Mer_POApproval_5" %>
         ...
         <div style="height:220px; border:1px solid #2A89B5;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;">
            ...
            <td style="vertical-align:top">
               ...
               <div style="height:530px; width:850px; overflow:auto">
                   <cc3:C1GridView ID="grdPORevised" runat="server" AllowColMoving="True" 
                       AllowColSizing="True" AllowPaging="True" AllowSorting="True" 
                       AutoGenerateColumns="False" DefaultColumnWidth="" 
                       onfiltering="grdPORevised_Filtering" 
                       onpageindexchanging="grdPORevised_PageIndexChanging" 
                       onrowdatabound="grdPORevised_RowDataBound" PageSize="24" ShowFilter="True" 
                       ...
                       <Columns>
                           ...
                           <cc3:C1BoundField DataField="cAtt" HeaderText="Attention" ShowFilter="false" 
                           ...
                           <cc3:C1BoundField DataField="cCredtDay" HeaderText="Credit Days" 
                               ShowFilter="false" SortExpression="Credit Days">
                           </cc3:C1BoundField>
