<%@ Page Title="PO For Approval" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Smt_Mer_POApproval_2.aspx.cs" Inherits="Smt_Mer_POApproval_2" %>
          ...
          <div style="height:220px; border:1px solid #2A89B5;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;">
            ...
            <td style="vertical-align:top">
               ...
               <div style="height:530px; overflow:auto">
                  ...
                  <cc3:C1GridView ID="grdForApproval" runat="server" AllowColMoving="True" 
                       ...
                       onrowdatabound="grdForApproval_RowDataBound" PageSize="21" ShowFilter="True" 
                      ...
                      <Columns>
                          <cc3:C1TemplateField HeaderText="Report">
                           ...
                           <cc3:C1TemplateField HeaderText="Select">
                               <ItemTemplate>
                                   <asp:CheckBox ID="chkSelectforApp" runat="server" Width="25px" />
                           ...
                           <cc3:C1BoundField DataField="dEntdate" DataFormatString="{0:dd/MM/yyyy}" 
                               HeaderText="Created Date" HtmlEncode="false" SortExpression=" dEntdate">
                           </cc3:C1BoundField>
               ...
               <div style="border-top:1px solid #2A89B5; text-align:right; padding-right:8px; padding-top:2px">
                   <asp:Button ID="btnApproved" runat="server" CssClass="button" 
                       onclick="btnApproved_Click" Text="Approve" Width="120px" />
                   <asp:Button ID="btnRevise" runat="server" CssClass="button" Text="Revise" 
