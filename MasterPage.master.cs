...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    private void BindHashtableToControls()
    {
        Hashtable hashtable = DAL._xCrush;
        if (hashtable.Count > 0)
        {
            DataSet set = new DataSet();
            DataTable table = set.Tables.Add("ValuesFromHashTable");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        base.Response.AppendHeader("Cache-Control", "no-store");
        ...
        else if (!base.IsPostBack)
        {
            HtmlAnchor[] anchorArray = new HtmlAnchor[] {
                ...
                this.AMRpt, this.Adb, this.ADV, this.Aexp, this.amrpt2
            };
            HtmlGenericControl[] controlArray = new HtmlGenericControl[] {
                ...
                this.LMRpt, this.Ldb, this.LDV, this.lexp, this.lmrpt2
            };
            ...
            if (base.Session["UGroup"].ToString() != "1")
            {
                ...
                if (((frm != "Smt_Mainhome.aspx") && (frm != "Smt_ChangePassword.aspx")) && ((frm != "Smt_Setting.aspx") && (frm != "Smt_TNAMerchandising.aspx")))
                {
