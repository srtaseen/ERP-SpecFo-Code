<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDesignation.aspx.cs" Inherits="Master_Setup_frmDesignation" %>
                        ...
                        <td  style="margin:5px; padding:5px; border:1px solid #99ccff; background-color:#F9F9F9">
                            <table style="width: 100%;">
                                <tr>
                                    <td align="right">
                                        &nbsp;
                                        <asp:Label ID="Label1" runat="server" CssClass="label" Text="Designation"></asp:Label>
                                    </td>
                                    <td align="left" width="250px">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ControlToValidate="txtDesignation" Display="None" 
                                            ErrorMessage="Enter Designation" ValidationGroup="a">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td height="350px" valign="top">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                DataKeyNames="nDesignation_ID" 
                                onrowcommand="GridView1_RowCommand" PageSize="20" Width="100%">
                                <AlternatingRowStyle CssClass="grdAltr" />
                                <Columns>
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblid" runat="server" Text='<%# Eval("nDesignation_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="cDesignation" HeaderText="Designation" 
                                        SortExpression="cDesignation" />
