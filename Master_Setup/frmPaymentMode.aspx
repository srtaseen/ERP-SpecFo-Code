<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPaymentMode.aspx.cs" Inherits="Master_Setup_frmPaymentMode" %>
                    ...
                    <tr>
                        <td align="right" 
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" CssClass="label" Text="Payment Mode"></asp:Label>
                                    </td>
                                    <td align="left" width="230px">
                                        <asp:TextBox ID="txtFloor" runat="server" CssClass="textbox" MaxLength="20" 
                                            Width="200px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ControlToValidate="txtFloor" Display="None" ErrorMessage="Enter Payment Mode" 
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblid" runat="server" Text='<%# Eval("PM_NO") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
