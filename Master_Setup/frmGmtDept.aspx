<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmGmtDept.aspx.cs" Inherits="Master_Setup_frmGmtDept" %>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="Label2" runat="server" CssClass="label" 
                                            Text="Garment Department"></asp:Label>
                                    </td>
                                    <td>
                                        &nbsp;<asp:TextBox ID="txtDepartment" runat="server" CssClass="textbox" 
                                            MaxLength="20" onclick="clearlabel('lblErrormsg');" Width="180px"></asp:TextBox>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDepartment" 
                                            Display="None" ErrorMessage="Enter Garment Department" ValidationGroup="a">*</asp:RequiredFieldValidator>
...
&nbsp;<asp:Button ID="btnClear" runat="server" CssClass="button" onclick="btnClear_Click" Text="Clear" Width="80px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblid" runat="server" Text='<%# Eval("nGmt_Dept_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="cGmt_Dept_Description" 
                                        HeaderText="Garment Department" SortExpression="cGmt_Dept_Description" />
