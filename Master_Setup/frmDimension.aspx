<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDimension.aspx.cs" Inherits="Master_Setup_frmDimension" %>
                    ...
                    <tr>
                        <td  align="right" 
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" CssClass="label" Text="Dimension"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtDimension" runat="server" CssClass="textbox" MaxLength="30" 
                                            onclick="clearlabel('lblErrormsg');" Width="200px"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                            ControlToValidate="txtDimension" Display="None" ErrorMessage="Enter Dimension" 
                                            ValidationGroup="a">*</asp:RequiredFieldValidator>
                                        <asp:ValidatorCalloutExtender ID="RequiredFieldValidator1_ValidatorCalloutExtender" 
                                            runat="server" Enabled="True" TargetControlID="RequiredFieldValidator1">
                                        </asp:ValidatorCalloutExtender>

                                        <asp:FilteredTextBoxExtender ID="txtDimension_FilteredTextBoxExtender" runat="server" 
                           Enabled="True" FilterMode="InvalidChars" 
                           InvalidChars="'`~^$#@!" 
                           TargetControlID="txtDimension">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblDimnID" runat="server" CssClass="label" Visible="False"></asp:Label>
                                    </td>
                    ...
                    <tr>
                        <td height="350px" valign="top">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                onrowcommand="GridView1_RowCommand" PageSize="24" Width="100%">
                                ...
                                <Columns>
                                  ...
                                  <%--  <asp:BoundField DataField="nLgth" HeaderText="Length" SortExpression="nLgth" />--%>
                                </Columns>
