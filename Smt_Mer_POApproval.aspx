<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Smt_Mer_POApproval.aspx.cs" Inherits="Smt_Mer_POApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="width:160px; vertical-align:top">
                            <div style="height:235px; border:1px solid #2A89B5;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;">
                                <div style="border-bottom:1px solid #2A89B5; background-color:#3EA4D2; color:White; text-align:center; padding:3px">
                                    CONFIRM TO<br /> APPROVE
                                </div>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top">
                            <div style="border:1px solid #2A89B5; height:560px;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;">
                                <div style="height:530px">
                                    <cc3:C1GridView ID="grdConfirmToApprove" runat="server" AllowColMoving="True" 
                       AllowColSizing="True" AllowPaging="True" AllowSorting="True" 
                       AutoGenerateColumns="False" CellPadding="0" CellSpacing="0" 
                       DefaultColumnWidth="" EnableTheming="False" 
                       onfiltering="grdConfirmToApprove_Filtering" 
                       onpageindexchanging="grdConfirmToApprove_PageIndexChanging" 
                       onrowdatabound="grdConfirmToApprove_RowDataBound" PageSize="21" 
                       ...
                       VisualStylePath="~/C1WebControls/VisualStyles" Width="100%">
                           ...
                           <cc3:C1TemplateField HeaderText="Select">
                               <ItemTemplate>
                                   ...
                                   <asp:Label ID="lblponoforapp" runat="server" Text='<%# Eval("nPoNum") %>' 
                                       Visible="false"></asp:Label>                                  
                               </ItemTemplate>
                           </cc3:C1TemplateField>
                           <cc3:C1BoundField DataField="nPoNum" HeaderText="PO No" ShowFilter="true" 
                           ...
                           <cc3:C1BoundField DataField="dEntdate" DataFormatString="{0:dd/MM/yyyy}" 
                               HeaderText="Created Date" HtmlEncode="false" SortExpression="Created Date">
                           </cc3:C1BoundField>
                       ...
                       <PagerStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                ...
                                <div style="border-top:1px solid #2A89B5; text-align:right; padding-right:8px; padding-top:2px">
                   <asp:Button ID="btnCancel" runat="server" Text="Cancel" Width="120px" 
                       CssClass="button" onclick="btnCancel_Click" />
                   <asp:Button ID="btnconfirmtoapp" runat="server" Text="Confirm To Approve" 
                       Width="135px" CssClass="button" onclick="btnconfirmtoapp_Click" />
                   </div>
                            </div>   
                        </td>
                    </tr>
            ...
            <asp:ModalPopupExtender ID="Button2_ModalPopupExtender" runat="server" DynamicServicePath="" BackgroundCssClass="ModalPopupBG" BehaviorID="ppadditm" CancelControlID="cnclitmpdt" 
           OkControlID="cnclitmpdt" Enabled="True" PopupControlID="ppgenpo" 
           TargetControlID="btnppgntpo"></asp:ModalPopupExtender>
        </ContentTemplate>
    </asp:UpdatePanel>
